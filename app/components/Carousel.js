...
export default function Carousel() {
  ...
  return (
    <div className="carousel-container w-full h-96 relative">
      <Slider {...settings}>
        {/* Slide 1 */}
        <div className="relative">
          ...
          <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <h2 className="text-white text-2xl font-bold">Descubre Figuras Exclusivas </h2>
          </div>
        </div>
        {/* Slide 2 */}
        <div className="relative">
          ...
          />
          <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <h2 className="text-white text-2xl font-bold">Nuevas Figuras de tu Anime favorito</h2>
          </div>
        </div>
        {/* Slide 3 */}
        <div className="relative">
          ...
          />
          <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <h2 className="text-white text-2xl font-bold">Colecciona las Mejores Figuras con nosotros</h2>
          </div>
        </div>
      </Slider>
    </div>
